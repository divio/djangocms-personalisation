...
from .models import SegmentByCookiePluginModel


class SegmentByCookiePlugin(SegmentPluginBase):
    """
    ...
    model = SegmentByCookiePluginModel
...
plugin_pool.register_plugin(SegmentByCookiePlugin)
