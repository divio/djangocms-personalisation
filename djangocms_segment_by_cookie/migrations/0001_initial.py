...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='SegmentByCookiePluginModel',
            fields=[
                ('cmsplugin_ptr', models.OneToOneField(parent_link=True, related_name='djangocms_segment_by_cookie_segmentbycookiepluginmodel', auto_created=True, primary_key=True, serialize=False, to='cms.CMSPlugin')),
