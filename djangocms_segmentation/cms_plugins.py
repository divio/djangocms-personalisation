...
from .models import SegmentationPluginModel, SegmentFallbackPluginModel
...
class SegmentPluginBase(CMSPluginBase):
    ...
    parent_classes = ['SegmentationPlugin', ]
    render_template = 'djangocms_segmentation/_segment.html'
    text_enabled = False
...
class SegmentationPlugin(SegmentPluginBase):
    """
    ...
    allow_children = True
    model = SegmentationPluginModel
    module = _('Segmentation')
    name = _('Segmentation')
    parent_classes = None
    render_template = 'djangocms_segmentation/_limiter.html'

    allow_overrides = False

    def render(self, context, instance, placeholder):
        context = super(SegmentationPlugin, self).render(
...
class SegmentFallbackPlugin(SegmentPluginBase):
    """
    This segment plugin represents a degenerate case where the segment
    always matches.
    """

    model = SegmentFallbackPluginModel
    name = _('Fallback')
...
plugin_pool.register_plugin(SegmentationPlugin)
