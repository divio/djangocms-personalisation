...
from ..cms_plugins import PersonaliseByPluginBase
from ..models import PersonaliseByPluginBaseModel
...
class SegmentPool(object):
    ...
    def discover(self):
        ...
        for plugin_class in plugin_pool.get_all_plugins():
            if (issubclass(plugin_class, PersonaliseByPluginBase) and
    ...
    def register_segment_plugin(self, plugin_instance, suppress_discovery=False):
        ...
        if isinstance(plugin_instance, PersonaliseByPluginBaseModel):
    ...
    def unregister_segment_plugin(self, plugin_instance):
        ...
        if not isinstance(plugin_instance, PersonaliseByPluginBaseModel):
            ...
            for config_str, config in segment_class[self.CFGS]:
                ...
                for override, override_label in SegmentOverride.overrides_list:
                    ...
                    config_menu.add_ajax_item(
                        override_label,
                        action=reverse('admin:djangocms_personalisation_set_override'),
                        data={
